...
projects_router.register("results", views.ResultsViewSet, basename="result-sets") #the drf will create for us 2 route based on the basename: "result-sets-datail", "result-sets-list"
